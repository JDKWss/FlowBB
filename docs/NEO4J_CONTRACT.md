...
Stan: **zaakceptowany model danych**. Kolumna „Stan w repo” opisuje stan implementacji.
...
W podstawowym modelu relacja oznacza deklaracje udzialu i nie przechowuje strategii podrozy. Planowanie trasy nalezy do osobnego serwisu.
...
## Odczyty potrzebne PULSE (Nice to have)

Podstawowym odczytem pozostaje liczba relacji `IS_GOING_TO` dla wydarzenia. Rozszerzone agregaty transportowe i przestrzenne sa odlozone poza podstawowy zakres.
